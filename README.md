...
Current Website Dimension Requirments 
- Home Slideshow (Landscape): 2000 x 667
- Home Slideshow (Portrait) : 600  x 667
- Umich Rec Sports Logo     : 151  x 151
- Roster Photos             : 94   x 106
- Executive Photos          : 300  x 450

Where to complete each task
- To add People/Roster : `/public/data/roster.json`
- To change EBoard : `/public/data/about.json`
- To change slideshows photos : `/public/bannerPhotos`
- To add Pictures for Roster : `/public/rosterPhotos`
- To add School Logos (MUST BE SVG) : `/public/schools`
